...
- Client training on all relevant modules and features must be completed
- Bug fixes and minor adjustments are addressed based on client feedback during testing
- Documentation created or shared as needed for each deliverable
- Formal written sign-off required from client confirming ALL SOW deliverables have been met before the project can progress to Handhold

**Peer Review Process**
- Team members review and test each other's work before any client presentation or demonstration
- A second reviewer catches issues not apparent during self-testing
- Applies to all configuration, forms, journeys, campaigns, and documents without exception

**Mobile Compatibility**
- All forms must be tested for mobile compatibility before client demo
- Journey content must render correctly on mobile devices
- All questions must be presented correctly and be completable on mobile

**Message Template QA**
- SMS message length must be calculated including all possible reminders in a worst-case scenario
- Total SMS volume under worst-case conditions must be communicated to the client
- Client must confirm they are aware of and accept the SMS volume before go-live

**Sign-Off Gates**
- Formal written sign-off required from client after SOW is shared (Phase 5) before build begins
- Playback sign-off required from stakeholders before development starts (after Development Refinement)
- Final written sign-off required at end of Testing Phase (Phase 7) confirming all deliverables met before Handhold begins
