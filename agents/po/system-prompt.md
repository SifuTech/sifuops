...
<!-- PLACEHOLDER: Fill in your team's delivery methodology here.
     Examples:
     - "We use a Scrum backlog managed in Monday.com, with sprint planning fortnightly."
     - "We prioritise using MoSCoW and review with the client at each showcase."
     - "We operate under a fixed-price contract — scope changes require a formal change request."
     - "The PO is responsible for backlog ownership, acceptance sign-off, and stakeholder updates."
     Include who your typical stakeholders are (client sponsor, internal PM, end users, etc.)
-->
