...
- MoSCoW framework used for requirements prioritisation (Must, Should, Could, Won't)
- Change Review Board meets weekly to review and prioritise incoming items
- Items in the Scoping Backlog are prioritised by urgency
- PM is responsible for maintaining priority order in the development backlog
- Internal requests may enter directly at the Scoping Backlog stage, bypassing Inbox Triage

**Stakeholder Management**
- Commercial Team owns the client relationship pre-handover; PM owns it post-handover
- Regular progress updates provided to client at agreed intervals
- All client interactions and decisions must be logged
- Communication cadence established at the start of each project

**Change Control**
- All scope changes require a formal Change Request — no informal agreements
- CRs are escalated to the Commercial/Sales Team for approval
- Approved CRs must be communicated to the client and reflected in the updated project plan
- During Handhold phase: no new functionality is delivered under any circumstances — all new requirements follow the CR process

**Campaign & Journey Prioritisation**
- Status changes should occur on completion of a journey unless the client specifies otherwise
- Avoid over-complicating workflows with excessive statuses — challenge the client if this arises
...
{
  "risks": [
    "String describing a specific prioritisation or stakeholder risk"
  ],
  "watchouts": [
    "String describing a specific stakeholder dynamic or backlog management warning to monitor"
  ],
  "suggested_tasks": [
    {
